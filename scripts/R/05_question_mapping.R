...
# 1. LOAD
# =============================================================================
mapping <- read_csv("data/finetuning/wvs_question_mapping.csv", show_col_types = FALSE)
bielik  <- read_csv("data/finetuning/bielik_training_long.csv", show_col_types = FALSE)
qwen    <- read_csv("data/finetuning/qwen_training_long.csv", show_col_types = FALSE)
...
# 4. SAVE
# =============================================================================
write_csv(bielik_full, "data/finetuning/bielik_training_full.csv")
write_csv(qwen_full,   "data/finetuning/qwen_training_full.csv")
...
wvs_opinions <- read_csv("data/finetuning/all_personas_aggregated.csv", show_col_types = FALSE)

# The aggregated file has means but not per-question N counts
# We need to recompute from raw data

wvs_raw <- read_csv("C:/Users/Antoni/OneDrive/Pulpit/CuBoulder/2 sem/Study/WVS_Cross-National_Wave_7_csv_v6_0.csv",
                    show_col_types = FALSE)

COUNTRIES <- c("CHN", "SVK", "USA")
opinion_qs <- read_lines("data/finetuning/included_questions.txt")
...
bielik_full <- read_csv("data/finetuning/bielik_training_full.csv", show_col_types = FALSE)
qwen_full   <- read_csv("data/finetuning/qwen_training_full.csv", show_col_types = FALSE)
...
write_csv(bielik_filtered, "data/finetuning/bielik_training_full.csv")
write_csv(qwen_filtered,   "data/finetuning/qwen_training_full.csv")
