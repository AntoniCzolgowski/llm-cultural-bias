...
# Model results — load all baseline result files
model_results <- bind_rows(
  read_csv(file.path(results_dir, "baseline_gemma3.csv"), show_col_types = FALSE),
  read_csv(file.path(results_dir, "baseline_bielik.csv"), show_col_types = FALSE),
  read_csv(file.path(results_dir, "baseline_qwen.csv"),   show_col_types = FALSE)
)
