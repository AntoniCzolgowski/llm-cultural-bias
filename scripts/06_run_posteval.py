...
HUMAN_DIST_PATH = os.path.join(BASE_DIR, "data", "raw", "human_distributions.csv")
RESULTS_DIR = os.path.join(BASE_DIR, "results", "posteval")
CHECKPOINT_DIR = os.path.join(BASE_DIR, "checkpoints", "posteval")

MODEL_CONFIGS = {
    "bielik": {
        "base_path": os.path.join(MODELS_DIR, "bielik-11b-v3"),
        "lora_path": os.path.join(MODELS_DIR, "bielik-11b-v3-lora"),
        "save_name": "bielik_lora",
    },
    "qwen": {
        "base_path": os.path.join(MODELS_DIR, "qwen3-4b-instruct-2507"),
        "lora_path": os.path.join(MODELS_DIR, "qwen3-4b-lora"),
        "save_name": "qwen_lora",
    },
}
