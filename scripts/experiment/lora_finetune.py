...
MODEL_CONFIGS = {
    "bielik": {
        "path": f"{MODELS_DIR}/bielik-11b-v3",
        "training_data": f"{BASE_DIR}/data/finetuning/bielik_training_full.csv",
        "output_dir": f"{MODELS_DIR}/bielik-11b-v3-lora",
        "target_modules": ["q_proj", "v_proj"],
    },
    "qwen": {
        "path": f"{MODELS_DIR}/qwen3-4b-instruct-2507",
        "training_data": f"{BASE_DIR}/data/finetuning/qwen_training_full.csv",
        "output_dir": f"{MODELS_DIR}/qwen3-4b-lora",
        "target_modules": ["q_proj", "v_proj"],
    },
}
